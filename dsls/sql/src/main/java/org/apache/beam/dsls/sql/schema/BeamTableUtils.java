...
public final class BeamTableUtils {
  public static BeamSqlRecord csvLine2BeamSqlRow(
      CSVFormat csvFormat,
      String line,
      BeamSqlRecordTypeProvider beamSqlRowType) {
  ...
  public static String beamSqlRow2CsvLine(BeamSqlRecord row, CSVFormat csvFormat) {
  ...
  public static void addFieldWithAutoTypeCasting(BeamSqlRecord row, int idx, Object rawObj) {
    if (rawObj == null) {
