...
/**
 * Type provider for {@link BeamSqlRecord} with SQL types.
 *
 ...
 *
 */
public class BeamSqlRecordTypeProvider extends BeamRecordTypeProvider {
  ...
  protected BeamSqlRecordTypeProvider(List<String> fieldsName) {
    super(fieldsName);
  }

  public BeamSqlRecordTypeProvider(List<String> fieldsName, List<Integer> fieldsType) {
    super(fieldsName);
    this.fieldsType = fieldsType;
  }

  public static BeamSqlRecordTypeProvider create(List<String> fieldNames, List<Integer> fieldTypes) {
    return new BeamSqlRecordTypeProvider(fieldNames, fieldTypes);
  }
