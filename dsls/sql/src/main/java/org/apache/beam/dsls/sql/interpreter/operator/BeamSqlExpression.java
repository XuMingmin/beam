...
public abstract class BeamSqlExpression implements Serializable {
  ...
  public <T> T opValueEvaluated(int idx, BeamSqlRecord row) {
  ...
  /**
   * Apply input record {@link BeamSqlRecord} to this expression,
   * the output value is wrapped with {@link BeamSqlPrimitive}.
   */
  public abstract BeamSqlPrimitive evaluate(BeamSqlRecord inputRow);
