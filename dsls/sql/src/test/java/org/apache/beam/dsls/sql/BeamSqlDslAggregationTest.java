...
public class BeamSqlDslAggregationTest extends BeamSqlDslBase {
  ...
  private void runAggregationWithoutWindow(PCollection<BeamSqlRecord> input) throws Exception {
    ...
    BeamSqlRecordTypeProvider resultType = BeamSqlRecordTypeProvider.create(Arrays.asList("f_int2", "size"),
  ...
  private void runAggregationFunctions(PCollection<BeamSqlRecord> input) throws Exception{
    ...
    BeamSqlRecordTypeProvider resultType = BeamSqlRecordTypeProvider.create(
  ...
  private void runDistinct(PCollection<BeamSqlRecord> input) throws Exception {
  ...
  private void runTumbleWindow(PCollection<BeamSqlRecord> input) throws Exception {
    String sql = "SELECT f_int2, COUNT(*) AS `size`,"
  ...
  private void runHopWindow(PCollection<BeamSqlRecord> input) throws Exception {
    String sql = "SELECT f_int2, COUNT(*) AS `size`,"
  ...
  private void runSessionWindow(PCollection<BeamSqlRecord> input) throws Exception {
    String sql = "SELECT f_int2, COUNT(*) AS `size`,"
