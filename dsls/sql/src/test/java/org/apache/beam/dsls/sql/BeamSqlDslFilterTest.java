...
public class BeamSqlDslFilterTest extends BeamSqlDslBase {
  ...
  private void runSingleFilter(PCollection<BeamSqlRecord> input) throws Exception {
  ...
  private void runCompositeFilter(PCollection<BeamSqlRecord> input) throws Exception {
  ...
  private void runNoReturnFilter(PCollection<BeamSqlRecord> input) throws Exception {
  ...
  public void testFromInvalidTableName2() throws Exception {
    ...
    PCollection<BeamSqlRecord> result = boundedInput1.apply(BeamSql.simpleQuery(sql));
